...
class Neo4jAdapter(BaseGraphDatabase):
    """Adapter for Neo4j (AuraDB Free or self-hosted Neo4j instance)."""
    ...
    def __init__(
        ...
        super().__init__(name="Neo4j (AuraDB/Community)")
    ...
    def get_resource_footprint(self) -> Dict[str, Any]:
        return {
            "tier": "AuraDB Free / Capped Container",
            "vcpu": "0.5 vCPU",
            "memory": "256 MB - 512 MB RAM",
            "storage_limit": "1 GB disk",
            "engine": "Neo4j Native Graph Engine",
            "managed_cloud": "Yes (AuraDB) / Docker",
